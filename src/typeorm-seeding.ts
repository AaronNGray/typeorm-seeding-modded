...
export const factory: Factory =
  ...
  (context?: Context) => {
    ...
    const entityFactory = (<EntityFactoryDefinition<Entity, Context>> ((global as any).seeder.entityFactories.get(name)))?.factory
//    const entityFactory = (global as any).seeder.entityFactories.get(name)?.factory
    return new EntityFactory<Entity, Context>(name, entity, entityFactory, context)
  }
